    ...
    <div id="contact-view" className="animate-fade-in pt-24 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h1 className="font-serif font-extrabold text-4xl md:text-5xl text-[#3D1A0A] mt-3 mb-6">
            Hubungi <span className="text-gradient">Balai Tenun</span>
          </h1>
          <p className="text-[#7A6558] text-base md:text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="card-base p-8">
              <h2 className="font-serif text-2xl font-bold text-[#3D1A0A] mb-8 border-b border-[#EFE6DA] pb-4">Akses Langsung</h2>
              <div className="space-y-8 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#7A6558] leading-relaxed text-sm md:text-base">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#7A6558] text-sm md:text-base font-mono">+62 895-4217-7009</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#7A6558] text-sm md:text-base leading-relaxed">
                      ...
                      <span className="text-[#C8973A] text-xs">Ahad: Menerima kunjungan dengan reservasi</span>
                    </p>
                  </div>
                </div>
              </div>

              <div className="border-t border-[#EFE6DA] pt-6">
                <h3 className="text-xs font-mono font-bold uppercase tracking-widest text-[#C8973A] mb-4">Jejaring Media Sosial</h3>
                <div className="flex flex-wrap gap-3">
                  ...
                  <a href="mailto:balaitenunseraphine@gmail.com" className="flex items-center gap-2 px-5 py-3 bg-[#FBF8F4] text-[#7A6558] hover:text-[#3D1A0A] rounded-xl text-sm font-bold border border-[#EFE6DA] transition-colors">
                    <Mail className="w-4 h-4 text-[#C8973A]" /> Kirim Email
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 card-base overflow-hidden relative">
            {submitted && (
              <div className="absolute inset-0 bg-white/95 backdrop-blur-sm z-10 flex flex-col items-center justify-center text-center p-8 animate-fade-in">
                ...
                <h3 className="font-serif text-3xl font-bold text-[#3D1A0A] mb-3">Pesan Diterima</h3>
                <p className="text-[#7A6558] mb-6">Manifest korespondensi Anda telah terekam ke sistem administrasi kami. Kami akan merespons melalui kontak Anda segera.</p>
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-[10px] font-mono font-bold uppercase tracking-widest text-[#7A6558] mb-2">Subjek Topik</label>
                ...
                <div>
                  <label className="block text-[10px] font-mono font-bold uppercase tracking-widest text-[#7A6558] mb-2">Pesan & Pertanyaan *</label>
